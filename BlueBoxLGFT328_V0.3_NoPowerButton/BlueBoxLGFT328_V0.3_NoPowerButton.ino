...
void setup() {
  ...
  Serial.begin(9600);
  Serial.println("BlueBoxLGFT328 V0.3 NoPowerButton init");
  lcd.begin(8, 2);
...
*/
  ...
  if (Page == 0) {
    lcd.setCursor(0,0);
        ...
        double EEC2K = mapf(AR2k,87*4,516*4,213,1505);
        ...
        double EEC20K = mapf(AR20k,280*4,490*4,8380,15140);
    ...
    float PHMap = mapf(PH, Raw1PH*4, Raw2PH*4, Target1PH, Target2PH); // 220.5 - 0 !! 687.5 - 10
